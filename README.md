...
**Goal:** .\
**Execution and details:** It creates and draws a k-regular bipartite graph on a given number of vertices. It finds a PDS of the maximum size, and its vertices are colored in red. Alternatively, it tries to find a k-regular bipartite graph that has no PDS of the maximum size.
