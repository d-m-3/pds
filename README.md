...
- `usecase_tree.py`\
**Goal:** Create a random tree of maximum degree 3, find and draw a PDS of maximum size.
- `usecase_caterpillar.py`\
**Goal:** Create a random caterpillar of maximum degree 3, find and draw a PDS of maximum size.
